   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <form action="" method="post">
            ...
            <a href="admin_orders.php?delete=<?php echo $fetch_orders['id']; ?>" onclick="return confirm('delete this order?');" class="delete-btn">borrar</a>
         </form>
      </div>
      <?php
         }
      }else{
         echo '<p class="empty">no hay ninguna orden realizada!</p>';
      }
      ?>
   </div>
